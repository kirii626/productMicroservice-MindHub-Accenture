...
public class ExceptionHandlers {
    ...
    public ResponseEntity<Map<String, Object>> handleUserNotFoundException(ProductNotFoundExc ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleUserAlreadyExistsException(ProductAlreadyExistsExc ex) {
